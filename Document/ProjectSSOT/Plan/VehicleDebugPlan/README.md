...
### 2.12 `CF_VehDebugUX_CodexTask.md`

VehicleDebug Panel UX 1차 개선을 Codex가 수행할 수 있도록 정리한 작업 지시서다.

주요 내용:
- Phase UX-1/2 C++ 작업 범위
- 수정 대상 파일과 새 파일 목록
- Navigation / Selected Section 구현 지침
- `.uasset` 직접 편집 금지
- BP/UMG 수동 연결 체크리스트
- 빌드/검증 기준
...
### v0.4.0 - 2026-04-27
- Navigation Item 선택 표시를 문자열 접두사에서 버튼 배경색/텍스트 색 기반으로 개선한 내용을 문서 묶음 상태에 반영했다.

### v0.3.9 - 2026-04-27
- VehicleDebug Panel UX-1 C++ 기반 구현 결과를 문서 묶음 상태에 반영했다.
- Navigation + Selected Content 전환을 위한 C++ 기반과 남은 BP/UMG 수동 작업 기준을 연결했다.

### v0.3.8 - 2026-04-27
- `CF_VehDebugUX_CodexTask.md`를 추가해 VehicleDebug Panel UX 1차 개선 작업 지시서를 문서 묶음에 연결했다.
- C++ 작업 범위, `.uasset` 직접 편집 금지, BP/UMG 수동 연결 체크리스트, 검증 기준을 상위 안내에 반영했다.
