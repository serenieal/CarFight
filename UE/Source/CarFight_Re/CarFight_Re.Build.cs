...
// Version: v1.7.0
// Changelog:
// - v1.7.0: VBHAI-P0-07E Editor Automation progress sidecar JSON writer가 FJsonObject/FJsonSerializer를 사용하므로 Editor 빌드 전용 Private Json 의존성을 명시.
...
// Migration:
// - v1.7.0 Json 의존성은 Target.bBuildEditor 범위에만 추가하며 packaged/runtime Product 모듈 의존성은 확장하지 않는다.
