...
FString UCFTurretMountData::BuildTurretMountSummary() const
{
	...
	return FString::Printf(
		TEXT("TurretMountData: Id=%s, BaseMesh=%s, YawMesh=%s, PitchMesh=%s, YawPivot=%s, PitchPivot=%s, Muzzle=%s, Yaw=%.1f..%.1f, Pitch=%.1f..%.1f, TurnRate=%.1f/%.1f, Settle=%.2fs, AllowFireWhileAligning=%s, MuzzleClearance=%.1fcm, Weight=%.1fkg"),
